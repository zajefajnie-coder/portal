-- Schema MySQL dla portal-modelingowy.pl
-- Uruchom ten skrypt w swojej bazie danych MySQL

CREATE DATABASE IF NOT EXISTS portal_modelingowy CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE portal_modelingowy;
