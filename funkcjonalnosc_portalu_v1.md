# Funkcjonalność portalu modelingowego StageOne v1.1
...
## 3. Profil użytkownika – zakładki (jak v1.1.md)
...
## 4. System społecznościowy (z v1.1.md)
...
## 6. Bezpieczeństwo (pełne, jak v1.1.md)
...
stageone/
├── api/                 # API endpoints
├── includes/            # Konfiguracja, funkcje, połączenie z bazą
├── js/                  # Skrypty frontendowe
├── css/                 # Style CSS
├── uploads/             # Przesłane pliki użytkowników
├── sessions/            # Zdjęcia sesji
├── avatars/             # Awatary użytkowników
├── documents/           # Dokumenty (CV, booki)
├── admin/               # Panel administracyjny
├── moderator/           # Panel moderacyjny
...
- MySQL 8 (utf8mb4_unicode_ci, prepared statements, indeksy z `schema.sql`)
